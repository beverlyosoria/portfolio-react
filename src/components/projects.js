					...
					<Grid className="row">
							...
							<Card shadow={5} style={{ minwidth: '450' }}>
								...
								<CardText>
									<p>
										...
										movie. The user must guess the movie title to move on to the next set of images.
										The player wins when all movie titles are guessed correctly.
									</p>
								</CardText>
								<CardActions border>
									<Button>
						...
						<Cell coll={4}>
							<Card shadow={5} style={{ minWidth: '450' }}>
								...
								>
									a full-stack web application with Google authentication using Mongoose to add,
									create, update, and delete posts and reviews of local businesses based on the
									criteria of deaf-friendliness. The backend, built using Node, Express, and Mongo to
									create a well-developed RESTful API.
								</p>

								<CardText>
									<p>
										A place where you can search for deaf-friendly businesses in your area or share
										your consumer experience as deaf, deafblind, and hard of hearing individuals.
										The aim is to promote deaf-friendliness in your community via awareness and
										feedback.
									</p>
								</CardText>
								<CardActions border>
					...
					<Grid className="row">
						<Cell coll={4}>
							<Card shadow={5} style={{ minWidth: '450' }}>
								...
								>
									A collaborative project as Front-end Developer. A full-stack web application
									employing Python and Django to create group events and invite friends while Postgres
									was used to create a backend that stores users data.
								</p>

								<CardText>
									<p>
										Happiest Hour simplifies organizing a happy hour with your coworkers, planning a
										weekend with your friends, or coordinating a soccer practice with your teammates
										all in one place. Through the app, the user can suggest a place, set a time and
										location and share privately with a group of choice.
									</p>
								</CardText>
								<CardActions border>
